...
yourself. The files all begin spec - which is the internal name given to this
spectum. The files specpc.pi and/or specwt.pi are those which were
...
If you use the spec[wt|pc].pi files, Xspec will look for the back.pi and
